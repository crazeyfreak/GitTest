...
<body onload="Page_Load">
    <form id="form1" runat="server">
       <div style="">
           <asp:DropDownList ID="Select_Drop" runat="server" Width=20% OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass="dropdown">
            <asp:ListItem>Summery</asp:ListItem>
            <asp:ListItem>Detail</asp:ListItem>
        </asp:DropDownList>
        
        <asp:Button ID="Btn_gen" runat="server" Text="Generate" style="margin-left:20px; width:90px" OnClick="Btn_gen_Click" CssClass="btn btn-primary" />
           </div> 
